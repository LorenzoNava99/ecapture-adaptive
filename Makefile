...
help:
	...
	@echo ""
	@echo "# Android (macOS cross-compilation)"
	@echo "    $$ make macos-setup				# Setup macOS development environment"
	@echo "    $$ source android_build_env.sh		# Load Android build environment"
	@echo "    $$ make android					# Build eCapture for Android"
	@echo "    $$ make help-android				# Show Android-specific help"
